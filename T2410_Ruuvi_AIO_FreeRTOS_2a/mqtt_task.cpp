...
Adafruit_MQTT_Publish ruuvi_e6_temp  = Adafruit_MQTT_Publish(&mqtt, IO_USERNAME "/feeds/portimo.patteri");
Adafruit_MQTT_Publish ruuvi_ea_temp  = Adafruit_MQTT_Publish(&mqtt, IO_USERNAME "/feeds/portimo.ikkuna");
Adafruit_MQTT_Publish ruuvi_ea_rssi  = Adafruit_MQTT_Publish(&mqtt, IO_USERNAME "/feeds/portimo.ruuvi-ea-rssi");
Adafruit_MQTT_Publish ruuvi_ea_bat   = Adafruit_MQTT_Publish(&mqtt, IO_USERNAME "/feeds/portimo.ruuvi-ea-bat");
Adafruit_MQTT_Publish ruuvi_ed_temp  = Adafruit_MQTT_Publish(&mqtt, IO_USERNAME "/feeds/portimo.ruuvi-ed-temp");
