...
// --------TILAP HEKA----------------------------------------------------------
Adafruit_MQTT_Publish ruuvi_od_temp           = Adafruit_MQTT_Publish(&mqtt, IO_USERNAME "/feeds/ikkunalla.ulko-od-temp");
Adafruit_MQTT_Publish ruuvi_od_hum            = Adafruit_MQTT_Publish(&mqtt, IO_USERNAME "/feeds/ikkunalla.ulko-od-hum");
Adafruit_MQTT_Publish ruuvi_od_press          = Adafruit_MQTT_Publish(&mqtt, IO_USERNAME "/feeds/ikkunalla.ulko-od-press");
Adafruit_MQTT_Publish ruuvi_pa_temp           = Adafruit_MQTT_Publish(&mqtt, IO_USERNAME "/feeds/portimo.patteri-temp");
Adafruit_MQTT_Publish ruuvi_pp_temp           = Adafruit_MQTT_Publish(&mqtt, IO_USERNAME "/feeds/portimo.pakastin-temp");
/* TOM
...

{
    ...
    { &ruuvi_od_hum,  "f7:b7:f9:e1:42:8c", "PP-ulko-Hum",    NULL, false, UNIT_HUMIDITY   , 300000,  0}, 
    { &ruuvi_od_press,"f7:b7:f9:e1:42:8c", "PP-ulko-press",  NULL, false, UNIT_AIR_PRESSURE, 300000,  0},
    { &ruuvi_pa_temp, "eb:6c:a9:0b:41:f8", "PP-patt-Temp",   NULL, false, UNIT_TEMPERATURE, 300000,   0},
    { &ruuvi_pp_temp, "e3:f5:88:11:07:19", "PP-pakk-Temp",   NULL, false, UNIT_TEMPERATURE, 60000,   0}, 
  };                      
/* TOM
{
    { &ruuvi_e6_temp, "f7:b7:f9:e1:42:8c", "Ruuvi E6 Temp", NULL, false, UNIT_TEMPERATURE, 60000,   0}, 
    { &ruuvi_ea_temp, "e3:f5:88:11:07:19", "Ruuvi EA Temp", NULL, false, UNIT_TEMPERATURE, 60000,   0}, 
    { &ruuvi_ea_rssi, "f7:b7:f9:e1:42:8c", "Ruuvi EA RSSI", NULL, false, UNIT_RSSI,        300000,  0}, 
    { &ruuvi_ea_bat,  "e3:f5:88:11:07:19", "Ruuvi EA Bat ", NULL, false, UNIT_VOLTAGE,     300000,   0}, 
    { &ruuvi_ed_temp, "eb:6c:a9:0b:41:f8", "Ruuvi ED Temp", NULL, false, UNIT_TEMPERATURE, 60000,   0}, 
};
*/
